...
set_property PACKAGE_PIN V2 [get_ports {num[8]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {num[8]}]
set_property PACKAGE_PIN T3 [get_ports {num[9]}]                                        
        set_property IOSTANDARD LVCMOS33 [get_ports {num[9]}]
set_property PACKAGE_PIN T2 [get_ports {num[10]}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {num[10]}]
set_property PACKAGE_PIN R3 [get_ports {num[11]}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {num[11]}]
set_property PACKAGE_PIN W2 [get_ports {num[12]}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {num[12]}]
set_property PACKAGE_PIN U1 [get_ports {num[13]}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {num[13]}]
set_property PACKAGE_PIN T1 [get_ports {num[14]}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {num[14]}]
set_property PACKAGE_PIN R2 [get_ports {num[15]}]                                       
        set_property IOSTANDARD LVCMOS33 [get_ports {num[15]}]
